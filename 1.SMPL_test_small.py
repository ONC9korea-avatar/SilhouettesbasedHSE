...
infer_model_name = 'Oct_12_11:13:02_2023'
infer_model_path = f'./checkpoints/{infer_model_name}/ResnetPCA_small/epochs_1000.ckpt'
config_path = f'./checkpoints/{infer_model_name}/ResnetPCA_small/config.yaml'
...
infer_model = ResnetPCA_small(6890*3).to(device)
