...
def main():
    ...
    train_dataset = HSEDataset_aug(os.path.join(dataset_path, dataset_name), train_index)
    test_dataset = HSEDataset_aug(os.path.join(dataset_path, dataset_name), test_index)    
